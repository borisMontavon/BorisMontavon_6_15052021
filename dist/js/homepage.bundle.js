...
/***/ "./src/js/components/functions/tag-filter.js":
/*!***************************************************!*\
  !*** ./src/js/components/functions/tag-filter.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ TagFilter)\n/* harmony export */ });\nclass TagFilter {\r\n    elementHasSelectedTag(elements, tags) {\r\n        if (tags.length === 0) {\r\n            elements.forEach((element) => {\r\n                element.state.display = true;\r\n            });\r\n        } else {\r\n            elements.forEach((element) => {\r\n                const found = element.state.tags.some(tag => tags.includes(tag));\r\n\r\n                if (found) {\r\n                    element.state.display = true;\r\n                } else {\r\n                    element.state.display = false;\r\n                }\r\n            });\r\n        }\r\n    }\r\n}\n\n//# sourceURL=webpack://BorisMontavon_6_21032021/./src/js/components/functions/tag-filter.js?");
